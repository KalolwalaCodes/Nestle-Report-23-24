...
const BoardOfDirectorNew = () => {
  const bodArray = [
    ...
    ["Ms. Anjali Bansal", "Independent Non-Executive Director", "./Bod/MD4.png"],
    ["Ms. Alpana Parida", "Independent Non-Executive Director", "./Bod/MD5.png"],
    ["Ms. Svetlana Boldina", "Executive Director – F&C and CFO", "./Bod/MD6.png"],
    ["Mr. Satish Srinivasana", "Executive Director - Technical", "./Bod/MD7.png"],
  ...
  return (
    <div ref={ref} className='flex flex-wrap m-auto w-[90%] gap-10 justify-center'>
      {bodArray.map((data, key) => (
        <motion.div
          ...
          animate={controls}
          className="w-full sm:w-[45%] md:w-[30%] lg:w-[22%] xl:w-[15%] h-[380px] border border-gray-200 shadow border-pink-200 ml-4 rounded-lg"
        >
          <div className='h-[200px] w-auto m-auto red-orange-bg'>
            <img
              className="rounded-t-lg h-[200px] m-auto"
              src={data[2]}
              alt={data[0]}
            />
          </div>
