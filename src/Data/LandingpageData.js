...
export const dataToFeed=[
    ...
    ['./Landingpage/Artboard 4.svg','People','Investing in employees, empowering them, instilling diversity, and inclusion are essential for progress.'],
    ['./Landingpage/Artboard 5.svg','Planet','Embracing sustainable practices to reduce environmental impact and achieve equilibrium between progress and the planet.'],
    ['./Landingpage/Artboard 6.svg','Partnerships','Building strong relationships with stakeholders where collaboration fuels progress.'],
...
export const dataToFeedStory1=[
    ['./Landingpage/indiaStory/Artboard 5.svg','A legacy of112 years',' of safety, quality'],
