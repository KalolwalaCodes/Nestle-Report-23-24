...
other Nestlé markets - Vietnam, Philippines, MENA, Oceania, Indonesia and Japan showcasing its effectiveness in driving growth.
        ...
        Best-in-class security shield for data protection and digital assets
          ...
          <motion.div initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} className='w-full bg-slate-200 flex sm:flex-col md:flex-row align-middle'>
               
                <motion.img initial={{opacity:0,scale:0.5}} whileInView={{opacity:1,scale:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.2}} className=' md:w-[70%] lg:w-[50%]' src="./ProductPortfolio/Artboard 29@3x.webp" alt="" />
                <div className='p-4'>
                <motion.p initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} className="qus-para">
...
It is an AI-powered eB2B platform for RUrban markets that is more effective in driving sales than standalone applications.
        ...
        <br />
        <motion.b initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}}>Digitized and AI powered value stream</motion.b>
          <motion.p initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} className="normal-paragraph-container">
          ...
          <br />
          <motion.b initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}}>Sanand leads the way</motion.b>
          <motion.p initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} className="normal-paragraph-container">
          Your Company's Sanand factory serves as a shining example, operating as a completely digitized and paperless facility.               
               </motion.p>
                    <br />
                    <motion.b initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} >Sustainable deliveries</motion.b>
                    <motion.p initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}}  className="normal-paragraph-container">
                    ...
                    <br /> By leveraging AI, Your Company makes informed decisions about transportation routes, ensuring efficient and environmentally responsible logistics.   
                           </motion.p>
                    <br />
                    <div className='flex gap-8 sm:flex-col md:flex-row'>
                    <div>
                    <motion.b>Engagement platforms powered by Cloud & AI</motion.b>
                    <motion.p initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}}  className="normal-paragraph-container">
                    ...
                    <motion.img initial={{opacity:0,scale:0.5}} whileInView={{opacity:1,scale:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.2}} className='m-auto sm:w-full md:w-[38%]' src="./ProductPortfolio/Artboard 30@3x.webp" alt="" />
                    </div>
                    <br />
                    <motion.b initial={{opacity:0,y:"-10px"}} whileInView={{opacity:1,y:0}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} >Secure AI empowering employees</motion.b>
