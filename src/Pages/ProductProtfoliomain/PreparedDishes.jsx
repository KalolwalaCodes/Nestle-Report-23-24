    ...
    <div className="wrapper-main-product-portfolio">
      ...
      <div className="chairman-message-wrapper">
        <div className="flex sm:flex-col md:flex-row gap-8 mb-5 col-reverse-small">
          <motion.img
            ...
            src="./ProductPortfolio/Artboard 15@3x.webp"
            alt=""
          />
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            The Prepared Dishes and Cooking Aids business recorded a strong
            growth momentum. This was aided by a healthy balance of product mix,
            pricing and volume growth in MAGGI Noodles and MAGGI
            Masala-ae-Magic, supported by strong consumer engagement and market
            presence with media campaigns and attractive consumer activations.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="flex sm:flex-col md:flex-row">
            <div>
              Your Company worked on renewing the recipe for MAGGI Tomato
              Ketchup and it now has 22% less sugar.
              <br />
              ...
              waste), MAGGI empowered consumers to contribute to a greener
              future.
              <br />
            </div>
      ...
      <div className="chairman-message-wrapper">
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.5, ease: "easeInOut", delay: 0.2 }}
          className="big-medium-font my-3"
        >
        ...
        <div className="flex sm:flex-col md:flex-row gap-8 col-reverse-small ">
          <motion.img
            ...
            transition={{ duration: 0.5, ease: "easeInOut", delay: 0.2 }}
            className="sm:w-full md:w-[70%] object-contain "
            src="./ProductPortfolio/Artboard 18@3x.webp"
            alt=""
          />
          <motion.img
            initial={{ opacity: 0, scale: 0.5 }}
            ...
            className="sm:w-full md:w-[30%] object-contain "
            src="./ProductPortfolio/p27.webp"
            alt=""
          />
        </div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.5, ease: "easeInOut", delay: 0.2 }}
          className="flex sm:flex-col md:flex-row gap-6 mt-4 justify-between"
        >
      ...
      <div className="chairman-message-wrapper">
        ...
        <div className="flex sm:flex-col md:flex-row gap-8">
          <motion.img
            ...
            src="./ProductPortfolio/Artboard 21@3x.webp"
            alt=""
          />
          <p className="big-medium-font ">
            The Pet care portfolio which is a part of Prepared Dishes and
            Cooking Aids business continued to demonstrate its unwavering
        ...
        <div className="flex sm:flex-col md:flex-row gap-8">
          ...
          >
            The portfolio offers a comprehensive array of options catering to
            both canine and feline companions. For dogs, brands such as Purina
            ...
            convenient wet food option. The positive feedback was instrumental
            in driving trial purchases, paving the way to build a loyal feline
            following.
            <br /> Recognizing the ever-evolving needs of pet owners, your
            Company expanded the reach of the portfolio through e-commerce
            channels. This was proven highly successful, making it easier for
            pet parents to access the food their furry companions love,
            conveniently delivered right to their doorsteps.
          </motion.p>
          <img
            className="md:w-[30%] sm:w-full object-contain"
            src="./ProductPortfolio/p29q.webp"
            alt=""
          />
        </div>
      </div>
