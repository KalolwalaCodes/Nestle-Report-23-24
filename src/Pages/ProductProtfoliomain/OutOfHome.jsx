  ...
  return (
    <div className="wrapper-main-product-portfolio">
      ...
      <div className="chairman-message-wrapper">
        ...
        <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.2}} className="big-medium-font my-4 ">
       ...
       The Out-of-Home business reported strong growth, propelled by portfolio transformation and premiumization, channel prioritization and new customer acquisition.
        ...
        <motion.img className="object-contain"  initial={{opacity:0,scale:0.5}} whileInView={{opacity:1,scale:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.2}} src="./ProductPortfolio/Artboard 26@3x.webp" alt="" />
        < motion.img className="object-contain"   initial={{opacity:0,scale:0.5}} whileInView={{opacity:1,scale:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.3}} src="./ProductPortfolio/Artboard 27@3x.webp" alt="" />
        <div>
        
       <motion.img className="object-contain"  initial={{opacity:0,scale:0.5}} whileInView={{opacity:1,scale:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.2}} src="./ProductPortfolio/p35q.webp" alt="" />
       <br />
        ...
        <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.2}}  className="normal-paragraph-container  sm:w-full my-4 mb-0 ">
...
Thai and Coastal cuisines.
        ...
        <motion.p initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.5,ease:"easeInOut",delay:0.4}} className="normal-paragraph-container " >Your Company's ‘Retail ONE' initiative fostered entrepreneurship by setting up over 830 branded kiosks such as NESCAFÉ Corners, MAGGI Hotspots, KITKAT Break Zones in educational institutes, hospital food zones, malls and airports. These kiosks are operator funded, and created employment opportunities for more than 1,600 people. Approximately 30% of the food handlers in the kiosks
        are women.</motion.p>
      </div>
    </div>
  )
